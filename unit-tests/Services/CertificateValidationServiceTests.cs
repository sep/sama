...
l7gRQ21qJTK5suoiYoYNo3J9T+pXPGU7Lydz/HwW+w0DpArtAaukI8aNX4ohFUKS
wDSiIIWIWJiJGbEeIO0TIFwEVWTOnbNl/faPXpk5IRXicapqiII="));
        private static X509Certificate2 EXAMPLE_CERT_INVALID = new X509Certificate2(Convert.FromBase64String(@"

...
ieqRbcuFjmqfyPmUv1U9QoI4TQikpw7TZU0zYZANP4C/gj4Ry48/znmUaRvy2kvI
l7gRQ21qJTK5suoiYoYNo3J9T+pXPGU7Lydz/HwW+w0DpArtAaukI8aNX4ohFUKS
wDSiIIWIWJiJGbEeIO0TIFwEVWTOnbNl/faPXpk5IRXicbpqiII="));
        ...
        public void ValidateLdapShouldThrowWhenUsingCustomCertAndNonChainPolicyErrorsExist()
        {
            ...
            AssertSslException(() => _service.ValidateLdap(null, System.Net.Security.SslPolicyErrors.RemoteCertificateNotAvailable), true, "certificate is unavailable");
        }
        ...
        public void ValidateHttpEndpointShouldThrowWhenUsingCustomCertAndNonChainPolicyErrorsExist()
        {
            ...
            AssertSslException(() => _service.ValidateHttpEndpoint(ep, null, System.Net.Security.SslPolicyErrors.RemoteCertificateNotAvailable), false, "certificate is unavailable");
        }
